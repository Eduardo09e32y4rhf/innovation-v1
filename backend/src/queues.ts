...
const bullOptions = connection === "mock" ? {
...
export const userMonitor = new QueueClass("UserMonitor", connection === "mock" ? "redis://127.0.0.1:6379" : connection, bullOptions);

export const queueMonitor = new QueueClass("QueueMonitor", connection === "mock" ? "redis://127.0.0.1:6379" : connection, bullOptions);

export const messageQueue = new QueueClass("MessageQueue", connection === "mock" ? "redis://127.0.0.1:6379" : connection, {
  ...bullOptions,
  limiter: {
...
export const scheduleMonitor = new QueueClass("ScheduleMonitor", connection === "mock" ? "redis://127.0.0.1:6379" : connection, bullOptions);
export const sendScheduledMessages = new QueueClass(
  "SendScheduledMessages",
  connection === "mock" ? "redis://127.0.0.1:6379" : connection,
  bullOptions
);

export const campaignQueue = new QueueClass("CampaignQueue", connection === "mock" ? "redis://127.0.0.1:6379" : connection, bullOptions);
