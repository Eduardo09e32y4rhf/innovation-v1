...
O Innovation é uma empresa distribuidora de White Label que possui uma solução de atendimentos via Whatsapp que aumenta a produtividade e organização das equipes

## 🚀 Começando

O repositório do Innovation possui 3 pastas importantes:
- backend
- frontend
- instalador
...
Todos os direitos reservados a https://innovation.com
